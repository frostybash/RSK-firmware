...
#Additional flags
PREPROCESSOR_MACROS += ARM_MATH_CM0 flash_layout STM32F051C8  USE_HAL_LEGACY STM32F051x8 USE_HAL_DRIVER
INCLUDE_DIRS += . $(BSP_ROOT)/STM32F0xxxx/STM32F0xx_HAL_Driver/Inc $(BSP_ROOT)/STM32F0xxxx/STM32F0xx_HAL_Driver/Inc/Legacy $(BSP_ROOT)/STM32F0xxxx/CMSIS_HAL/Core/Include $(BSP_ROOT)/STM32F0xxxx/CMSIS_HAL/Device/ST/STM32F0xx/Include $(BSP_ROOT)/STM32F0xxxx/CMSIS_HAL/Include $(BSP_ROOT)/STM32F0xxxx/CMSIS_HAL/RTOS2/Include
LIBRARY_DIRS += 
LIBRARY_NAMES += 
...
LINKER_SCRIPT := $(BSP_ROOT)/STM32F0xxxx/LinkerScripts/STM32F051C8_flash.lds
