...
void acces_ADAR7251_reg_write (uint16_t R_W, uint16_t addr,uint16_t reg_data);
void Set_pin_mod_trig_low(void);
void DAC_triangle ( uint16_t DAC_data);
void LMX2491_singleTone(void);
void LMX2491_Saw(void);
void LMX2491_Saw_kmc4(void);
...
void acces_ADAR7251_reg_write (uint16_t R_W, uint16_t addr,uint16_t reg_data)
{
	...
	HAL_GPIO_WritePin(GPIOB, ADC_SS_Pin, GPIO_PIN_RESET);
	Delay_u(100);
	HAL_SPI_Transmit(&hspi1,(uint8_t*)&R_W,sizeof(R_W),1000);
	Delay_u(100);
	HAL_SPI_Transmit(&hspi1,(uint8_t*)&addr,sizeof(addr),1000);
	Delay_u(100);
	HAL_SPI_Transmit(&hspi1,(uint8_t*)&reg_data,sizeof(reg_data),1000);
	Delay_u(100);
	HAL_GPIO_WritePin(GPIOB, ADC_SS_Pin, GPIO_PIN_SET);
}

void Set_pin_mod_trig_low(void)
{
	HAL_GPIO_WritePin(GPIOA, pll_MOD_Pin|fault_mcu_adc_Pin|rst_pwd_mcu_adc_Pin, GPIO_PIN_SET);
	Delay_u(10);
}
void BGT24MTR_reg_init(void)
{	
	uint16_t BGT_data1 = 0x0060;
...
void TEST(void)
{
			HAL_GPIO_WritePin(GPIOA, Q2_mcu_Pin, GPIO_PIN_SET);
      HAL_Delay(100);
			HAL_GPIO_WritePin(GPIOA, Q2_mcu_Pin, GPIO_PIN_RESET);
			HAL_Delay(100);
}
...
void LMX2491_write_reg (uint8_t value,uint8_t value1,uint8_t value2) // write reg function
{
	value = value;
	value1 = value1;
	value2 = value2;
...
void LMX2491_Saw(void)     // functions for Saw with ramp period 1000 um and 1000 um return
{
    ...
    LMX2491_write_reg(0x00,0x60,0x3F);  
    LMX2491_write_reg(0x00,0x5F,0xFF);   
    LMX2491_write_reg(0x00,0x5E,0xFC);  
    LMX2491_write_reg(0x00,0x5D,0x54);   
    LMX2491_write_reg(0x00,0x5C,0x20);   
    LMX2491_write_reg(0x00,0x5B,0xC3);   
    LMX2491_write_reg(0x00,0x5A,0x50);   
    LMX2491_write_reg(0x00,0x59,0x00);   
    LMX2491_write_reg(0x00,0x58,0x00);   
    LMX2491_write_reg(0x00,0x57,0x03);   
    LMX2491_write_reg(0x00,0x56,0xAC);   
    LMX2491_write_reg(0x00,0x55,0x00);   
    LMX2491_write_reg(0x00,0x54,0x00);   
    LMX2491_write_reg(0x00,0x53,0x00);   
    LMX2491_write_reg(0x00,0x52,0x05);   
    LMX2491_write_reg(0x00,0x51,0x00);   
    LMX2491_write_reg(0x00,0x50,0x00);   
    LMX2491_write_reg(0x00,0x4F,0x00);  
    LMX2491_write_reg(0x00,0x4E,0xFF);   
    ...
    LMX2491_write_reg(0x00,0x3C,0x00);   
    LMX2491_write_reg(0x00,0x3B,0x00);   
    LMX2491_write_reg(0x00,0x3A,0x01);   
    LMX2491_write_reg(0x00,0x39,0x00);   
    LMX2491_write_reg(0x00,0x2D,0x00);   
    LMX2491_write_reg(0x00,0x2C,0x00);   
    LMX2491_write_reg(0x00,0x2B,0x00);   
    ...
    LMX2491_write_reg(0x00,0x29,0x00);   
    LMX2491_write_reg(0x00,0x28,0x00);   
    LMX2491_write_reg(0x00,0x27,0x92);   
    LMX2491_write_reg(0x00,0x26,0x42);   
    LMX2491_write_reg(0x00,0x25,0x92);   
    LMX2491_write_reg(0x00,0x24,0x4A);   
    LMX2491_write_reg(0x00,0x23,0x41);   
...
void LMX2491_Saw_kmc4(void)     // functions for Saw like a kmc4
{
		
    LMX2491_write_reg(0x00,0x8D,0x00);   
    LMX2491_write_reg(0x00,0x8C,0x13);   
    LMX2491_write_reg(0x00,0x8B,0x64);   
    LMX2491_write_reg(0x00,0x8A,0x00);   
    LMX2491_write_reg(0x00,0x89,0x00);   
    LMX2491_write_reg(0x00,0x88,0x00);   
    LMX2491_write_reg(0x00,0x87,0x00);   
    ...
    LMX2491_write_reg(0x00,0x84,0x64);   
    LMX2491_write_reg(0x00,0x83,0x00);   
    LMX2491_write_reg(0x00,0x82,0x00);   
    LMX2491_write_reg(0x00,0x81,0x00);   
    LMX2491_write_reg(0x00,0x80,0x00);   
    ...
    LMX2491_write_reg(0x00,0x7D,0x64);   
    LMX2491_write_reg(0x00,0x7C,0x00);   
    LMX2491_write_reg(0x00,0x7B,0x00);   
    LMX2491_write_reg(0x00,0x7A,0x00);   
    LMX2491_write_reg(0x00,0x79,0x00);   
    LMX2491_write_reg(0x00,0x78,0x00);   
    LMX2491_write_reg(0x00,0x77,0x00);   
    LMX2491_write_reg(0x00,0x76,0x64);   
    LMX2491_write_reg(0x00,0x75,0x00);   
    LMX2491_write_reg(0x00,0x74,0x00);   
    LMX2491_write_reg(0x00,0x73,0x00);   
    LMX2491_write_reg(0x00,0x72,0x00);   
    LMX2491_write_reg(0x00,0x71,0x00);   
    LMX2491_write_reg(0x00,0x70,0x27);   
    LMX2491_write_reg(0x00,0x6F,0x10);   
    LMX2491_write_reg(0x00,0x6E,0x3F);   
    LMX2491_write_reg(0x00,0x6D,0xFC);   
    LMX2491_write_reg(0x00,0x6C,0xED);   
    LMX2491_write_reg(0x00,0x6B,0x91);   
    LMX2491_write_reg(0x00,0x6A,0x60);   
    LMX2491_write_reg(0x00,0x69,0x27);   
    LMX2491_write_reg(0x00,0x68,0x10);   
    LMX2491_write_reg(0x00,0x67,0x00);   
    LMX2491_write_reg(0x00,0x66,0x03);   
    LMX2491_write_reg(0x00,0x65,0x12);   
    LMX2491_write_reg(0x00,0x64,0x6F);  
    LMX2491_write_reg(0x00,0x63,0x40);   
    LMX2491_write_reg(0x00,0x62,0x27);   
    LMX2491_write_reg(0x00,0x61,0x10);   
    LMX2491_write_reg(0x00,0x60,0x3F);  
    LMX2491_write_reg(0x00,0x5F,0xFC);   
    LMX2491_write_reg(0x00,0x5E,0x6A);  
    LMX2491_write_reg(0x00,0x5D,0x7F);   
    LMX2491_write_reg(0x00,0x5C,0x20);   
    LMX2491_write_reg(0x00,0x5B,0x27);   
    LMX2491_write_reg(0x00,0x5A,0x10);   
    LMX2491_write_reg(0x00,0x59,0x00);   
    LMX2491_write_reg(0x00,0x58,0x03);   
    LMX2491_write_reg(0x00,0x57,0x95);   
    LMX2491_write_reg(0x00,0x56,0x81);   
    LMX2491_write_reg(0x00,0x55,0x00);   
    LMX2491_write_reg(0x00,0x54,0x00);   
    LMX2491_write_reg(0x00,0x53,0x00);   
    LMX2491_write_reg(0x00,0x52,0xFA);   
    LMX2491_write_reg(0x00,0x51,0x00);   
    LMX2491_write_reg(0x00,0x50,0x00);   
    LMX2491_write_reg(0x00,0x4F,0x00);  
    LMX2491_write_reg(0x00,0x4E,0xCE);   
    LMX2491_write_reg(0x00,0x4D,0x00);   
    LMX2491_write_reg(0x00,0x4C,0x00);   
    LMX2491_write_reg(0x00,0x4B,0x00);   
    LMX2491_write_reg(0x00,0x4A,0x00);   
    ...
    LMX2491_write_reg(0x00,0x22,0x04);   
		...
		LMX2491_write_reg(0x00,0x1B,0x08);   
		LMX2491_write_reg(0x00,0x1A,0x00);
		LMX2491_write_reg(0x00,0x19,0x64);
		LMX2491_write_reg(0x00,0x18,0x00);
		...
		LMX2491_write_reg(0x00,0x13,0x00);
		LMX2491_write_reg(0x00,0x12,0x2C); 
		LMX2491_write_reg(0x00,0x11,0x05);
		LMX2491_write_reg(0x00,0x10,0xDC); 
		LMX2491_write_reg(0x00,0x0F,0x00);
		LMX2491_write_reg(0x00,0x0E,0x00);
		LMX2491_write_reg(0x00,0x0D,0x00);
		LMX2491_write_reg(0x00,0x0C,0x00);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, pll_MOD_Pin|fault_mcu_adc_Pin|rst_pwd_mcu_adc_Pin|Q2_mcu_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, spi_CE_pll_Pin|LE_pll_Pin|CS_bgt_Pin|ADC_SS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : pll_MOD_Pin fault_mcu_adc_Pin rst_pwd_mcu_adc_Pin Q2_mcu_Pin */
  GPIO_InitStruct.Pin = pll_MOD_Pin|fault_mcu_adc_Pin|rst_pwd_mcu_adc_Pin|Q2_mcu_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PA6 PA12 PA15 */
  GPIO_InitStruct.Pin = GPIO_PIN_6|GPIO_PIN_12|GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : spi_CE_pll_Pin LE_pll_Pin CS_bgt_Pin ADC_SS_Pin */
  GPIO_InitStruct.Pin = spi_CE_pll_Pin|LE_pll_Pin|CS_bgt_Pin|ADC_SS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
